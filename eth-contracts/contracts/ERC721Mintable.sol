...
contract Ownable {
    ...
    modifier onlyOwner()
            {
                require(msg.sender == _owner, "Only contract owner is allowed to call");
                _;
            }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "Recipient is already token owner.");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getOwner() ||  isApprovedForAll(getOwner(), msg.sender) == true, "Sender not owner or approved operator");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId) && (to != address(0x0)), "Token already exists or invalid address");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(to != address(0x0), "Recipient adddress is not a valid address");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function getSymbol() external view 
                         returns (string memory) {
        return _symbol;
    }

    function getBaseTokenURI() external view 
                               returns (string memory) {
